...
if __name__ == "__main__":
    dataset_path = "/home/kali/Downloads/CIC-IDS_2018.csv"  # <- Replace with your dataset
    drop_columns = ['Flow ID', 'Source IP', 'Destination IP', 'Timestamp']  # Customize per dataset
